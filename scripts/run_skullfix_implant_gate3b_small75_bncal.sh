...
CONFIG="cfgs/SkullFix_models/AdaPoinTr_implant_small75_bncal.yaml"
EXP_NAME="skullfix_implant_small75_bncal"
EXP_DIR="experiments/AdaPoinTr_implant_small75_bncal/SkullFix_models/${EXP_NAME}"
...
for split in val test; do
  CONFIG="$CONFIG" \
  SPLIT="$split" \
  OUT_DIR="logs/skullfix_implant_eval/small75_bncal_${split}" \
