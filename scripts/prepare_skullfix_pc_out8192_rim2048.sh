...
OUT_ROOT="${OUT_ROOT:-$HOME/datasets/SkullFixPC_out8192_rim2048}"
SEED="${SEED:-20260708}"
...
mkdir -p data
if [[ -e data/SkullFixPC_out8192_rim2048 && ! -L data/SkullFixPC_out8192_rim2048 ]]; then
  echo "[error] data/SkullFixPC_out8192_rim2048 exists and is not a symlink" >&2
  exit 1
fi
ln -sfn "$OUT_ROOT" data/SkullFixPC_out8192_rim2048
