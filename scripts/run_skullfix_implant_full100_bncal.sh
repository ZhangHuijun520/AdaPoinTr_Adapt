...
EXP_NAME="skullfix_implant_full100_bncal"
EXP_DIR="experiments/AdaPoinTr_implant_full100_bncal/SkullFix_models/${EXP_NAME}"
...
for split in val test; do
  CONFIG="$CONFIG" \
  SPLIT="$split" \
  OUT_DIR="logs/skullfix_implant_eval/full100_bncal_${split}" \
...
SPLIT=test \
NUM_SAMPLES=10 \
OUT_DIR="experiments/visualizations/skullfix_implant_full100_bncal_test" \
