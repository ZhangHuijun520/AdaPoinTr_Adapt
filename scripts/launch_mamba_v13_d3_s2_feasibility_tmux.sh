...
SESSION="${TMUX_SESSION:-mamba-v13-d3-s2-feasibility}"
STAMP="$(date +%Y%m%d_%H%M%S)"
MASTER_LOG="${ROOT}/logs/mamba_v13_d3_mug500plus/s2_head_feasibility_tmux/tmux_${STAMP}.log"
...
bash scripts/run_mamba_v13_d3_s2_feasibility.sh \
2>&1 | tee '$MASTER_LOG'; \
status=\${PIPESTATUS[0]}; \
