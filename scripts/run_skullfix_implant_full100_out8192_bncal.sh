...
EXP_NAME="skullfix_implant_full100_out8192_bncal"
EXP_DIR="experiments/AdaPoinTr_implant_full100_out8192_bncal/SkullFix_models/${EXP_NAME}"
...
CONFIG="$CONFIG" \
SPLIT=test \
OUT_DIR="logs/skullfix_implant_point_count/full100_out8192_bncal_test" \
SAVE_PREDICTIONS_DIR="logs/skullfix_implant_point_count/full100_out8192_predictions_test" \
bash scripts/eval_skullfix_implant.sh "${EXP_DIR}/ckpt-last-bncal.pth"

CONFIG="$CONFIG" \
SPLIT=test \
NUM_SAMPLES=10 \
OUT_DIR="experiments/visualizations/skullfix_implant_full100_out8192_bncal_test" \
